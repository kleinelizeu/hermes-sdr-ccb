...
passo_credenciais() {
  ...
  cat <<'EOT'
  Seu agente conversa com você pelo Telegram. Vamos criar um "bot" (grátis):

   1. Abra o Telegram e procure por:  @BotFather
   2. Mande a mensagem:  /newbot
   3. Dê um nome (ex.: "SDR da Minha Loja")
   4. Dê um nome de usuário terminando em "bot" (ex.: sdrminhalojabot)
   5. O BotFather devolve um TOKEN parecido com:
      1234567890:AAEhBOweik6ad9r_QXMENQOcrGoyXqNDdPk
EOT
  while true; do
