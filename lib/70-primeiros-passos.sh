...
passo_primeiros_passos() {
  passo "PRONTO! SEU AGENTE SDR ESTÁ NO AR 🎉"
  ...
  echo
  nota "(Para ver isto de novo depois:  hermes-sdr contexto)"
  ...
  info "hermes-sdr doctor    -> conferir se está tudo certo / corrigir problemas"
  info "hermes-sdr info      -> ver endereço do webhook, chave e nome do bot"
  info "hermes-sdr contexto  -> ver de novo o texto do seu negócio para colar"
  echo
  ok "Bom trabalho! Qualquer coisa, rode  hermes-sdr doctor."
}
